...
public class ConfigurationRegistry
{
	...
	private ConfigurationRegistry()
	{
		 ...
		 putLocalizedText(deLocale, "bam", new String[]{"der Brückenschlag", "der Lückenfüller", "der Missing Link", "ein unbeschreibliches Phänomen", "Augenwischerei", "ein Knaller", "das Entfant Terrible"});
		 putLocalizedText(deLocale, "tbt-adj1", new String[]{"wertorientierter", "unerschütterlicher", "erhabener", "tiefer", "nationaler", "historischer", "integrierter", "kreativer", "permanenter", "echter", "konstruktiver", "emanizpatorischer", "ambivalenter", "qualifizierter", "infantiler"});
		 ...
		 putLocalizedText(deLocale, "tbt-adj3", new String[]{"Unbedingt", "Auf jeden Fall", "Unmissverständlich", "Absolut", "Heftig", "Zwingend"});
		 putLocalizedText(deLocale, "tbt-compound1", new String[]{"Fluktuations-", "Beziehungs-", "Innovations-", "Koalitions-", "Motivations-", "Aktions-", "Identifikations-", "Kommunikations-", "Interpretations-", "Erinnerungs-", "Seins-", "Wesens-", "Zukunfts-", "Java-", "Hunde-", "Patriarchats-"});
		 putLocalizedText(deLocale, "tbt-compound2", new String[]{"Gemeinschaft", "Gläubigkeit", "Verstrickung", "Gewißheit", "Verpflichtung", "Bewahrung", "Aussage", "Phase", "Potenz", "Flexibilität", "Akzeleration", "Defenestration", "Problematik", "Tendenz", "Konzeption", "Präferenz", "Infantilität"});
