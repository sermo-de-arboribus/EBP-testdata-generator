...
public class ConfigurationRegistry
{
	...
	private ConfigurationRegistry()
	{
		 ...
		 putLocalizedText(deLocale, "bookgenre", new String[]{"Romanen", "Gedichten", "Ratgebern", "Reiseführern", "Hörbüchern", "Computerprogrammen", "Spielen", "Büchern", "E-Mails", "opulenten Booklets", "Coffee-Table-Büchern", "Folianten", "Schriftrollen", "Manuskripten", "Essays", "Artikeln", "Aufsätzen", "Traktaten", "Reflexionen", "Klageliedern", "Panegyriken", "Palimpsesten"});
		 ...
		 putLocalizedText(deLocale, "tbt-adj3", new String[]{"Unbedingt", "Auf jeden Fall", "Unmissverständlich", "Absolut", "Heftig", "Zwingend", "Krass", "Muss man"});
		 putLocalizedText(deLocale, "tbt-compound1", new String[]{"Fluktuations-", "Beziehungs-", "Innovations-", "Koalitions-", "Motivations-", "Aktions-", "Identifikations-", "Kommunikations-", "Interpretations-", "Erinnerungs-", "Seins-", "Wesens-", "Zukunfts-", "Java-", "Hunde-", "Patriarchats-", "Handels-", "Matriarchats-"});
