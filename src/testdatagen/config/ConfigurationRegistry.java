...
public class ConfigurationRegistry
{
	...
	private ConfigurationRegistry()
	{
		 ...
		 putLocalizedText(deLocale, "bookgenre", new String[]{"Romanen", "Gedichten", "Ratgebern", "Reiseführern", "Hörbüchern", "Computerprogrammen", "Spielen", "Büchern", "E-Mails", "opulenten Booklets", "Coffee-Table-Büchern", "Folianten", "Schriftrollen", "Manuskripten", "Essays", "Artikeln", "Aufsätzen", "Traktaten", "Reflexionen", "Klageliedern"});
		 ...
		 putLocalizedText(deLocale, "when", new String[]{"gestern", "letztes Jahr", "2014", "im Sommer", "zur Sternzeit 32634,9", "neulich", "zurück in der Zukunft", "nie"});
		 putLocalizedText(deLocale, "booktitle", new String[]{"100 Tage Heimat", "Wer den Taler sehr ehrt, ist des Mitleids nicht wert", "Der Zahlenteufel", "Barça - Die großen Jahre", "Dicke Lippe trotz Diät", "The Big Lewanstki", "Garga und Gurgelstrozza", "Die Poesie der Asphaltbrüche", "Adam und Eva treffen Harold und Maude", "Eine einzelne, von der aufgehenden Sonne rosa gefärbte Quellwolke", "Die wahre Geschichte des B Q", "Affentheuerlich naupengeheuerliche Textilklitterung", "Leidenschaftliche Naturerkundungen mit Hacke und Schaufel", "Die Kybernetik der Herrschaftslosigkeit", "Denn die Menschen singen nicht, sie lesen"});
		 putLocalizedText(deLocale, "prize", new String[]{"die Financial-Times-Ehrennadel 2012", "den Wolfdietrich-Schnurre-Gedächtnispreis", "den Pervitinküchen-Chefkochtitel 2013", "den MXSW-Preis 2015", "die Virenschleuder 2011", "die Pommesgabel der Wackengeschädigten 2014", "Kachelfrau-Preis 2015", "den Johann-Gottfried-Säumnis-Preis 1998", "den Freddy-Schillert-Preis"});
