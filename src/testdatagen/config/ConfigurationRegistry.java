...
public class ConfigurationRegistry
{
	...
	private ConfigurationRegistry()
	{
		 ...
		 putLocalizedText(deLocale, "birthplace", new String[]{"Ransbach-Baumbach", "Bietigheim-Bissingen", "Pirna-Niedervogelgesang", "Kobern-Gondorf", "Treis-Karden", "Solingen-Ohligs", "Bernkastel-Kues", "Traben-Trarbach", "Castrop-Rauxel", "Mettlach-Orscholz", "Moers", "Unna", "Dessau", "Dresden", "Mauritius", "Dnjepropetrowsk", "Jindřichův Hradec", "České Budějovice", "Falun", "Ouagadougou", "Shangri-La", "Madras", "Isfahan", "Kuşadası", "Horní Plana", "Wladiwostok", "Harbin", "einer Almhütte", "einem Flugzeug auf dem Weg von Chicago nach San Antonio", "Cartagena", "Guatemala", "Luanda", "einem Bergsteigerzelt auf dem Kilimandscharo", "Pleurtuit in der Bretagne"});
		 putLocalizedText(deLocale, "bookgenre", new String[]{"Romanen", "Gedichten", "Ratgebern", "Reiseführern", "Hörbüchern", "Computerprogrammen", "Spielen", "Büchern", "E-Mails"});
		 putLocalizedText(deLocale, "topic", new String[]{"Oasen", "Schnittblumen", "Sonnuntergänge", "die Psychologie der Jahreszeiten", "fernöstliche Esstechniken", "das Reparieren von Kugelschreibern", "die Schatzkammer von Dagobert Duck", "die schönsten Zuflüsse von Saale und Unstrut", "die polnisch-deutsche Versöhnung", "die Beulwerte ausgesteifter Rechteckplatten", "den Anbau von Zitruspflanzen in Südostanatolien", "Veganismus"});
		 putLocalizedText(deLocale, "when", new String[]{"gestern", "letztes Jahr", "2014", "im Sommer", "zur Sternzeit 32634,9"});
		 putLocalizedText(deLocale, "booktitle", new String[]{"100 Tage Heimat", "Wer den Taler sehr ehrt, ist des Mitleids nicht wert", "Der Zahlenteufel", "Barça - Die großen Jahre", "Dicke Beine trotz Diät", "The Big Lewanstki", "Garga und Gurgelstrozza", "Die Poesie der Asphaltbrüche", "Adam und Eva treffen Harold und Maude"});
		 putLocalizedText(deLocale, "prize", new String[]{"die Financial-Times-Ehrennadel 2012", "den Wolfdietrich-Schnurre-Gedächtnispreis", "den Pervitinküchen-Meistertitel 2013", "den MXSW-Preis 2015", "die Virenschleuder 2011", "die Pommesgabel der Wackengeschädigten 2014"});
		 putLocalizedText(deLocale, "residence", new String[]{"in einer WG mit Ellen Frauenknecht", "in einer Düne an der Nordsee", "tief im Wald, gleich neben Walder (sic!) Moers", "heute hier, morgen dort", "in Schneckenfischbach im Allgäu", "unter dem Neckarstadion", "im Beutel eines Känguruhs"});
		 ...
		 putLocalizedText(deLocale, "bam", new String[]{"der Brückenschlag", "der Lückenfüller", "der Missing Link", "ein unbeschreibliches Phänomen", "Augenwischerei"});
		 ...
		 putLocalizedText(deLocale, "tbt-adj2", new String[]{"permanenter", "systematisierter", "funktionaler", "integrierter", "kreativer", "bedenklicher", "machtvoller", "dieser unserer", "freudiger", "abendländischer", "morgenländischer", "nordamerikanischer", "georgischer", "gregorianischer"});
		 ...
		 putLocalizedText(deLocale, "tbt-imperative", new String[]{"lesen", "anschauen", "herunterladen", "begrüßen", "gebrauchen", "kaufen"});
	}
