...
public class ConfigurationRegistry
{
	...
	private ConfigurationRegistry()
	{
		 ...
		 putLocalizedText(deLocale, "bam", new String[]{"der Brückenschlag", "der Lückenfüller", "der Missing Link", "ein unbeschreibliches Phänomen", "Augenwischerei", "ein Knaller", "das Entfant Terrible", "wie eine Rakete"});
		 putLocalizedText(deLocale, "tbt-adj1", new String[]{"wertorientierter", "unerschütterlicher", "erhabener", "tiefer", "nationaler", "historischer", "integrierter", "kreativer", "permanenter", "echter", "konstruktiver", "emanizpatorischer", "ambivalenter", "qualifizierter", "infantiler", "wohl erforschter"});
		 putLocalizedText(deLocale, "tbt-adj2", new String[]{"permanenter", "systematisierter", "funktionaler", "integrierter", "kreativer", "bedenklicher", "machtvoller", "dieser unserer", "freudiger", "abendländischer", "morgenländischer", "nordamerikanischer", "georgischer", "gregorianischer", "altruistischer", "evolutionsbiologischer", "spekulativer"});
		 putLocalizedText(deLocale, "tbt-adj3", new String[]{"Unbedingt", "Auf jeden Fall", "Unmissverständlich", "Absolut", "Heftig", "Zwingend", "Krass"});
		 putLocalizedText(deLocale, "tbt-compound1", new String[]{"Fluktuations-", "Beziehungs-", "Innovations-", "Koalitions-", "Motivations-", "Aktions-", "Identifikations-", "Kommunikations-", "Interpretations-", "Erinnerungs-", "Seins-", "Wesens-", "Zukunfts-", "Java-", "Hunde-", "Patriarchats-", "Handels-"});
